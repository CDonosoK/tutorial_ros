...
- El **clientePersonalizado.py** es un cliente que utiliza el servicio personalizado para enviar datos
 ...
 ---
  ...
  - **Terminal N°3:** ```rosrun tutorial-ros movimientoLineal.py```
    ...
    Las siguientes líneas de comando corresponden a como mover hacer que el robot el robot gire en el punto, para ello se debe ejecutar los siguientes comandos:
